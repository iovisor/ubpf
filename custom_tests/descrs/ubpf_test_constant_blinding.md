...
3. **32-bit ALU Immediate Operations**: Tests all 32-bit immediate ALU operations (ADD, SUB, OR, AND, XOR, MOV) with and without blinding
4. **64-bit ALU Immediate Operations**: Tests all 64-bit immediate ALU operations (ADD64, SUB64, OR64, AND64, XOR64, MOV64) with and without blinding
...
- 32-bit: ADD_IMM, SUB_IMM, OR_IMM, AND_IMM, XOR_IMM, MOV_IMM
- 64-bit: ADD64_IMM, SUB64_IMM, OR64_IMM, AND64_IMM, XOR64_IMM, MOV64_IMM
