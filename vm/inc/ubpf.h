...
#define UBPF_EBPF_NONVOLATILE_SIZE (sizeof(uint64_t) * 5)
     ...
     *
     * The default profile is \ref UBPF_EXECUTION_PROFILE_LEGACY. This must be
     * selected before code is loaded, JIT compilation is attempted, or program
     * execution begins.
     *
     ...
     * invoked from the legacy execution profile if desired.
     *
