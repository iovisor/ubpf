...
privilidges in order to be run.
...
in the repo but an example of how to generate only and apply it to a
benchmark is given below.
```
$ dd if=/dev/urandom of=./bench/crc32.mem bs=4k count=2
$ clang -O2 -target bpf -c ./bench/crc32.c -o ./bench/crc32.o
$ sudo ./vm/test -i -m ./bench/crc32.mem ./bench/crc32.o 
0x2b9a4d6c
