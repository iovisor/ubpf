...
**Verification**: tests/, custom_tests/, test_framework/

**Focus Areas**: To be specified by the user at session start. If no focus area is specified, perform a full audit. Recommended starting point: core VM and JIT compiler (vm/ directory).
